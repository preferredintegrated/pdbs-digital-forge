    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gradient-pink via-gradient-purple to-gradient-blue">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-delay-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-2">
            <Button
              size="lg"
              className="bg-white text-gradient-purple hover:bg-white/90 font-semibold px-8 py-6 text-lg group transition-all shadow-lg hover:shadow-xl"
            >
              Get Started
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-gradient-purple font-semibold px-8 py-6 text-lg transition-all"
            >
              Our Services
            </Button>
          </div>
